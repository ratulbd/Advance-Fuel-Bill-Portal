...
export const env = {
  ...
  fuelBillBillSentDateCol: intEnv("FUEL_BILL_BILL_SENT_DATE_COL", 5),
  fuelBillTier1ReceiveCol: intEnv("FUEL_BILL_TIER1_RECEIVE_COL", 13),
  fuelBillTier1SubmitCol: intEnv("FUEL_BILL_TIER1_SUBMIT_COL", 19),
  fuelBillTier2ReceiveCol: intEnv("FUEL_BILL_TIER2_RECEIVE_COL", 22),
  fuelBillTier2SubmitCol: intEnv("FUEL_BILL_TIER2_SUBMIT_COL", 27),
  fuelBillTier3ReceiveCol: intEnv("FUEL_BILL_TIER3_RECEIVE_COL", 30),
  fuelBillTier3SubmitCol: intEnv("FUEL_BILL_TIER3_SUBMIT_COL", 34),
  fuelBillTier4ReceiveCol: intEnv("FUEL_BILL_TIER4_RECEIVE_COL", 37),
  fuelBillTier4SubmitCol: intEnv("FUEL_BILL_TIER4_SUBMIT_COL", 41),
  ...
  pettyCashBillSentDateCol: intEnv("PETTY_CASH_BILL_SENT_DATE_COL", 7),
  pettyCashTier1ReceiveCol: intEnv("PETTY_CASH_TIER1_RECEIVE_COL", 17),
  pettyCashTier1SubmitCol: intEnv("PETTY_CASH_TIER1_SUBMIT_COL", 21),
  pettyCashTier2ReceiveCol: intEnv("PETTY_CASH_TIER2_RECEIVE_COL", 24),
  pettyCashTier2SubmitCol: intEnv("PETTY_CASH_TIER2_SUBMIT_COL", 28),
  pettyCashTier3ReceiveCol: intEnv("PETTY_CASH_TIER3_RECEIVE_COL", 31),
  pettyCashTier3SubmitCol: intEnv("PETTY_CASH_TIER3_SUBMIT_COL", 35),
